...
int main()
{
  ...
  /*
  XGpioPs_WriteReg(XPAR_XGPIOPS_0_BASEADDR, 0x2C, 0x80000000);
  XGpioPs_WriteReg(XPAR_XGPIOPS_0_BASEADDR, 0x344, 0x80000000);
  XGpioPs_WriteReg(XPAR_XGPIOPS_0_BASEADDR, 0x348, 0x80000000);
  XGpioPs_WriteReg(XPAR_XGPIOPS_0_BASEADDR, 0x54, 0x80000000);
  XGpioPs_WriteReg(XPAR_XGPIOPS_0_BASEADDR, 0x54, 0);
  XGpioPs_WriteReg(XPAR_XGPIOPS_0_BASEADDR, 0x54, 0x80000000);
  ...
  //Xil_Out32(ADDR_MODE_REG, 0xC0000000);
*/
  while (1)
  {
