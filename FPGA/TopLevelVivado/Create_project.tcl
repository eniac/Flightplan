...
#
# Project.tcl: Tcl script for re-creating project 'TopLevelVivado'
#
...
# Create project
create_project $PROJECT ./$PROJECT -part xczu9eg-ffvb1156-2-i
...
set_property "ip_repo_paths" [ list \
  "[file normalize "$origin_dir/$P4_DIR"]"\
...
set obj [get_filesets sources_1]
set files [list \
 "[file normalize "$origin_dir/Sources/$SOURCE_DIR/design_1.bd"]"\
 "[file normalize "$origin_dir/Sources/$SOURCE_DIR/design_1_wrapper.vhd"]"\
]
...
set file "[file normalize "$origin_dir/Sources/$SOURCE_DIR/Constraints.xdc"]"
