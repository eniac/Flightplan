...
#
# Create_project.tcl: Tcl script for re-creating project 'ForwarderVivado'
#
...
# Create project
create_project ForwarderVivado ./ForwarderVivado -part xczu9eg-ffvb1156-2-i
...
set obj [get_projects ForwarderVivado]
set_property -name "board_part" -value "xilinx.com:zcu102:part0:3.0" -objects $obj
set_property -name "default_lib" -value "xil_defaultlib" -objects $obj
set_property -name "ip_cache_permissions" -value "read write" -objects $obj
set_property -name "ip_output_repo" -value "$proj_dir/ForwarderVivado.cache/ip" -objects $obj
...
puts "INFO: Project created:ForwarderVivado"
