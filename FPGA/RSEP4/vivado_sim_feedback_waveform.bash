...
g++ -std=gnu++11 -c -m64 -Wa,-W -fPIC ./XilinxSwitch.TB/XilinxSwitch.cpp -o xsim.dir/xsc/XilinxSwitch.o -I./XilinxSwitch.TB/ -I./Parser_t.TB/ -I./Forward_lvl_t.TB/ -I./Forward_lvl_0_t.TB/ -I./loop_0_t.TB/ -I./Forward_lvl_1_t.TB/ -I./fec_0_t.TB/ -I./Forward_lvl_2_t.TB/ -I./Deparser_t.TB/  -D__USE_XOPEN2K8 -DHAVE_DECL_BASENAME=1 
...
${XILINX_VIVADO}/bin/xelab -L work --debug all -sv_lib dpi.so XilinxSwitch_feedback_tb -s XilinxSwitch_feedback_tb_sim -L fifo_generator_v13_1_4=${XILINX_VIVADO}/data/xsim/ip/fifo_generator_v13_1_4 
${XILINX_VIVADO}/bin/xsim XilinxSwitch_feedback_tb_sim -gui -wdb work.XilinxSwitch_feedback_tb_tb.wdb  
