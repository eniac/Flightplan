...
#
# Project.tcl: Tcl script for re-creating project 'RSEVivado'
#
...
# Create project
create_project RSEVivado ./RSEVivado -part xczu9eg-ffvb1156-2-i
...
set obj [get_projects RSEVivado]
set_property -name "board_part" -value "xilinx.com:zcu102:part0:3.0" -objects $obj
set_property -name "default_lib" -value "xil_defaultlib" -objects $obj
set_property -name "ip_cache_permissions" -value "read write" -objects $obj
set_property -name "ip_output_repo" -value "$proj_dir/RSEVivado.cache/ip" -objects $obj
...
set_property "ip_repo_paths" [ list \
  "[file normalize "$origin_dir/../RSEP4/Wharf/XilinxSwitch"]"\
...
puts "INFO: Project created:RSEVivado"
