...
control Crosspod(inout headers_t hdr, inout booster_metadata_t m, inout metadata_t meta) {
    ...
    apply {
      if (!hdr.fp.isValid()) {
        ...
        bit<V1S_WIDTH_PORT_NUMBER> q1 = meta.ingress_port;
        bit<V1S_WIDTH_PORT_NUMBER> q2 = meta.egress_spec;
...
#endif
            meta.ingress_port = (bit<V1S_WIDTH_PORT_NUMBER>)q1;
            meta.egress_spec = (bit<V1S_WIDTH_PORT_NUMBER>)q2;
            init_computation(hdr);
