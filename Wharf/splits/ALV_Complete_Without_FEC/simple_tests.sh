...
#
# Modified from tests.sh to disable FEC and test a simple topology testing - KIM.

TOPOLOGY=$WHARF_REPO/splits/ALV_Complete_Without_FEC/simple_alv_k=4.yml
...
function complete_mcd_e2e {
  ...
  TARGET_LOG=${LOG_DUMPS}/p1h0_prog_4.log
