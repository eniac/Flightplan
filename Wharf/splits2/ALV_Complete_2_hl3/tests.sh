...
#
# FIXME this file mostly duplicates splits/ALV_Complete_1_hl3/tests.sh
...
export TOPOLOGY=splits2/ALV_Complete_2_hl3/alv_k=4.yml
...
function interactive_complete {
  ...
  sudo -E python bmv2/start_flightplan_mininet.py ${TOPOLOGY} \
          ...
          --verbose \
          --showExitStatus \
     --fg-host-prog ": /home/nsultana/2/P4Boosters/Wharf/splits2/ALV_Complete_2_hl3/start2.sh" \
