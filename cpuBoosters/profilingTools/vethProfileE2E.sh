...
ENCODER_PROFILE_OUT=$OUTDIR/encoder_profile.txt
DECODER_PROFILE_OUT=$OUTDIR/decoder_profile.txt
...
../fecBoosters/$ENCODER_NAME -i backVeth1 -o frontVeth2 -r $RULES_TABLE  2> $ENCODER_OUT 1> $ENCODER_PROFILE_OUT &
echo "**** STARTING $FORWARD_NAME > $FORWARD_OUT"
../fecBoosters/$FORWARD_NAME -i backVeth2 -o frontVeth3 2> $FORWARD_OUT &
echo "**** STARTING $DECODER_NAME > $DECODER_OUT "
../fecBoosters/$DECODER_NAME -i backVeth3 -o frontVeth4 -r $RULES_TABLE 2> $DECODER_OUT 1> $DECODER_PROFILE_OUT &
