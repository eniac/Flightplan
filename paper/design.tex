...
\begin{figure}
  \centering
  \includegraphics[width=0.3\paperwidth]{loss_example.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.3\paperwidth]{loss_example2.pdf}
...
to understand the design from plain text for people unfamilar with this. Also, there are too many
...
\begin{figure}
  \centering
  \includegraphics[width=0.3\paperwidth]{decode_example.pdf}
