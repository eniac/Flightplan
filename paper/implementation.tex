...
%This allowed us to implement our function as a stream processor, for cut-through behavior through SDNet.
...
to the header processor. \hg{This sentence (the glueing part) has become a
repetition of the last sentence (the chaining part).}
