...
xv_path="/home/gyzuh/SDx/SDx/2017.1/Vivado"
...
{
  file="xsim.ini"
  lib_map_path="/home/gyzuh/SDx/SDx/2017.1/Vivado/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
