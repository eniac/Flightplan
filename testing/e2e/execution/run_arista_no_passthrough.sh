...
OUTPUT=../e2e_output_500k_arista_no_passthrough_2
...
run_shremote() {
    ...
    for i in $(seq 1 5); do
        ../../Shremote/shremote.py cfgs/arista_e2e_no_passthrough_500k.yml ${BASE_LABEL}_$ITER \
...
slackme "Experiment set $SUFFIX succeeded!"
