...
run_booster () {
    python ../../Shremote/shremote.py cfgs/tofino_moongen.yml ${LABEL}_$1 --out $OUT/$LABEL --args="rate:$1;p_collision:0.1;dataplane_flags:-k;gen_mcd_flags:--zipf-random $ZIPF" --delete;
    RTN=$?
    RETRIES=1
    while [[ $RTN != 0 ]]; do
